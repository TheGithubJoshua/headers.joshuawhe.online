...
<head>
    <meta charset="utf-8">
    <title>WGWidgetLifeCycleSequence.h</title>
...
/PrivateFrameworks/Widgets.framework/WGWidgetLifeCycleSequence.h <a href="?download" download title="Download" class="download">&darr;</a>
