...
<head>
    <meta charset="utf-8">
    <title>WGWidgetVisibilityManager.h</title>
...
/PrivateFrameworks/Widgets.framework/WGWidgetVisibilityManager.h <a href="?download" download title="Download" class="download">&darr;</a>
