...
<head>
    <meta charset="utf-8">
    <title>MTLTelemetryTexture.h</title>
...
/PrivateFrameworks/MetalTools.framework/MTLTelemetryTexture.h <a href="?download" download title="Download" class="download">&darr;</a>
