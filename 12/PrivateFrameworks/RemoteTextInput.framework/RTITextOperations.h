...
<head>
    <meta charset="utf-8">
    <title>RTITextOperations.h</title>
...
/PrivateFrameworks/RemoteTextInput.framework/RTITextOperations.h <a href="?download" download title="Download" class="download">&darr;</a>
