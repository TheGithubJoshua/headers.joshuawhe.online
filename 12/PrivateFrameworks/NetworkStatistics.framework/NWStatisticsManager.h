...
<head>
    <meta charset="utf-8">
    <title>NWStatisticsManager.h</title>
...
/PrivateFrameworks/NetworkStatistics.framework/NWStatisticsManager.h <a href="?download" download title="Download" class="download">&darr;</a>
