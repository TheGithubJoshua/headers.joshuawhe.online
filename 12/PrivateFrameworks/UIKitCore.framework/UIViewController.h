...
<head>
    <meta charset="utf-8">
    <title>UIViewController.h</title>
...
/PrivateFrameworks/UIKitCore.framework/UIViewController.h <a href="?download" download title="Download" class="download">&darr;</a>
...
- (void)disableInteractiveDismissal;
