...
<head>
    <meta charset="utf-8">
    <title>UISplitViewControllerPanelImpl.h</title>
...
/PrivateFrameworks/UIKitCore.framework/UISplitViewControllerPanelImpl.h <a href="?download" download title="Download" class="download">&darr;</a>
