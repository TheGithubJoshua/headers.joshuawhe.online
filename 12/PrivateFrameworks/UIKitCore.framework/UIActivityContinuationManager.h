...
<head>
    <meta charset="utf-8">
    <title>UIActivityContinuationManager.h</title>
...
/PrivateFrameworks/UIKitCore.framework/UIActivityContinuationManager.h <a href="?download" download title="Download" class="download">&darr;</a>
