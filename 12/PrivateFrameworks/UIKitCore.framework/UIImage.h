...
/PrivateFrameworks/UIKitCore.framework/UIImage.h <a href="?download" download title="Download" class="download">&darr;</a>
...
+ (id)tableCellImageForGenericApplication;
+ (id)tableCellImageForProxy:(id)arg1;

- (id)initWithSystemName:(id)arg1 withConfiguration:(id)arg2;
- (id)initWith_systemName:(id)arg1;
