...
<head>
    <meta charset="utf-8">
    <title>MCGlobalHTTPProxyPayload.h</title>
...
/PrivateFrameworks/ManagedConfiguration.framework/MCGlobalHTTPProxyPayload.h <a href="?download" download title="Download" class="download">&darr;</a>
