...
<head>
    <meta charset="utf-8">
    <title>TIHandwritingStrokes.h</title>
...
/PrivateFrameworks/TextInput.framework/TIHandwritingStrokes.h <a href="?download" download title="Download" class="download">&darr;</a>
