...
<head>
    <meta charset="utf-8">
    <title>HFAccessoryInfoDetailsItemProvider.h</title>
...
/PrivateFrameworks/Home.framework/HFAccessoryInfoDetailsItemProvider.h <a href="?download" download title="Download" class="download">&darr;</a>
