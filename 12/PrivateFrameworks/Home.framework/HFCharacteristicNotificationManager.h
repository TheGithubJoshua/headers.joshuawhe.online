...
<head>
    <meta charset="utf-8">
    <title>HFCharacteristicNotificationManager.h</title>
...
/PrivateFrameworks/Home.framework/HFCharacteristicNotificationManager.h <a href="?download" download title="Download" class="download">&darr;</a>
