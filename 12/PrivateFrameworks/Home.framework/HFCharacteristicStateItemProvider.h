...
<head>
    <meta charset="utf-8">
    <title>HFCharacteristicStateItemProvider.h</title>
...
/PrivateFrameworks/Home.framework/HFCharacteristicStateItemProvider.h <a href="?download" download title="Download" class="download">&darr;</a>
