...
<head>
    <meta charset="utf-8">
    <title>HFMultiStateValueSet.h</title>
...
/PrivateFrameworks/Home.framework/HFMultiStateValueSet.h <a href="?download" download title="Download" class="download">&darr;</a>
