...
<head>
    <meta charset="utf-8">
    <title>HFAccessorySettingDeviceOptionsAdapter.h</title>
...
/PrivateFrameworks/Home.framework/HFAccessorySettingDeviceOptionsAdapter.h <a href="?download" download title="Download" class="download">&darr;</a>
