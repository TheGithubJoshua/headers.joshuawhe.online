...
<head>
    <meta charset="utf-8">
    <title>HFCharacteristicValueDisplayMetadata.h</title>
...
/PrivateFrameworks/Home.framework/HFCharacteristicValueDisplayMetadata.h <a href="?download" download title="Download" class="download">&darr;</a>
