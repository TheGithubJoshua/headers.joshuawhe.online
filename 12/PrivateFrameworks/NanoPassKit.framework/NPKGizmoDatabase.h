...
<head>
    <meta charset="utf-8">
    <title>NPKGizmoDatabase.h</title>
...
/PrivateFrameworks/NanoPassKit.framework/NPKGizmoDatabase.h <a href="?download" download title="Download" class="download">&darr;</a>
