...
<head>
    <meta charset="utf-8">
    <title>NPKPassSyncState.h</title>
...
/PrivateFrameworks/NanoPassKit.framework/NPKPassSyncState.h <a href="?download" download title="Download" class="download">&darr;</a>
