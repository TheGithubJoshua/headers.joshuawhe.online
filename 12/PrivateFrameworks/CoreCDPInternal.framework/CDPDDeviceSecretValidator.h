...
<head>
    <meta charset="utf-8">
    <title>CDPDDeviceSecretValidator.h</title>
...
/PrivateFrameworks/CoreCDPInternal.framework/CDPDDeviceSecretValidator.h <a href="?download" download title="Download" class="download">&darr;</a>
