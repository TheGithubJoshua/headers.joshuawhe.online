...
<head>
    <meta charset="utf-8">
    <title>GEOLogMsgStatePlaceCard.h</title>
...
/PrivateFrameworks/GeoServices.framework/GEOLogMsgStatePlaceCard.h <a href="?download" download title="Download" class="download">&darr;</a>
