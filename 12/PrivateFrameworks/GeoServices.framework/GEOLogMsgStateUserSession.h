...
<head>
    <meta charset="utf-8">
    <title>GEOLogMsgStateUserSession.h</title>
...
/PrivateFrameworks/GeoServices.framework/GEOLogMsgStateUserSession.h <a href="?download" download title="Download" class="download">&darr;</a>
