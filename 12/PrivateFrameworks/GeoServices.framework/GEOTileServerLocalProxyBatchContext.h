...
<head>
    <meta charset="utf-8">
    <title>GEOTileServerLocalProxyBatchContext.h</title>
...
/PrivateFrameworks/GeoServices.framework/GEOTileServerLocalProxyBatchContext.h <a href="?download" download title="Download" class="download">&darr;</a>
