...
<head>
    <meta charset="utf-8">
    <title>SXPreviewViewControllerManager.h</title>
...
/PrivateFrameworks/Silex.framework/SXPreviewViewControllerManager.h <a href="?download" download title="Download" class="download">&darr;</a>
