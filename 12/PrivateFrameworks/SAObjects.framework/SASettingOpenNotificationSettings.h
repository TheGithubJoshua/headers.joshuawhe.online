...
<head>
    <meta charset="utf-8">
    <title>SASettingOpenNotificationSettings.h</title>
...
/PrivateFrameworks/SAObjects.framework/SASettingOpenNotificationSettings.h <a href="?download" download title="Download" class="download">&darr;</a>
