...
<head>
    <meta charset="utf-8">
    <title>SAWebWebSearchResult.h</title>
...
/PrivateFrameworks/SAObjects.framework/SAWebWebSearchResult.h <a href="?download" download title="Download" class="download">&darr;</a>
