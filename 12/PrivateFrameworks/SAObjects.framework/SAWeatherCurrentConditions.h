...
<head>
    <meta charset="utf-8">
    <title>SAWeatherCurrentConditions.h</title>
...
/PrivateFrameworks/SAObjects.framework/SAWeatherCurrentConditions.h <a href="?download" download title="Download" class="download">&darr;</a>
