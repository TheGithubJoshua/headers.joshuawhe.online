...
<head>
    <meta charset="utf-8">
    <title>WBSURLCompletionDatabase.h</title>
...
/PrivateFrameworks/SafariShared.framework/WBSURLCompletionDatabase.h <a href="?download" download title="Download" class="download">&darr;</a>
