...
<head>
    <meta charset="utf-8">
    <title>NTPBPersonalizationConfig.h</title>
...
/PrivateFrameworks/NewsTransport.framework/NTPBPersonalizationConfig.h <a href="?download" download title="Download" class="download">&darr;</a>
