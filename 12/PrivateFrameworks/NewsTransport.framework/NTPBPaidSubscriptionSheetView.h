...
<head>
    <meta charset="utf-8">
    <title>NTPBPaidSubscriptionSheetView.h</title>
...
/PrivateFrameworks/NewsTransport.framework/NTPBPaidSubscriptionSheetView.h <a href="?download" download title="Download" class="download">&darr;</a>
