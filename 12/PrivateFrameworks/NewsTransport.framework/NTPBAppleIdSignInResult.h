...
<head>
    <meta charset="utf-8">
    <title>NTPBAppleIdSignInResult.h</title>
...
/PrivateFrameworks/NewsTransport.framework/NTPBAppleIdSignInResult.h <a href="?download" download title="Download" class="download">&darr;</a>
