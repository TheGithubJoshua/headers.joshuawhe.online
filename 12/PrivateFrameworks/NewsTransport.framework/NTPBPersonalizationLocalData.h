...
<head>
    <meta charset="utf-8">
    <title>NTPBPersonalizationLocalData.h</title>
...
/PrivateFrameworks/NewsTransport.framework/NTPBPersonalizationLocalData.h <a href="?download" download title="Download" class="download">&darr;</a>
