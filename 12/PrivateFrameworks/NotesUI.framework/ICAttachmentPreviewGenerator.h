...
<head>
    <meta charset="utf-8">
    <title>ICAttachmentPreviewGenerator.h</title>
...
/PrivateFrameworks/NotesUI.framework/ICAttachmentPreviewGenerator.h <a href="?download" download title="Download" class="download">&darr;</a>
