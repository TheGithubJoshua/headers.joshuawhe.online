...
<head>
    <meta charset="utf-8">
    <title>NoteAttachmentPresentation.h</title>
...
/PrivateFrameworks/NotesUI.framework/NoteAttachmentPresentation.h <a href="?download" download title="Download" class="download">&darr;</a>
