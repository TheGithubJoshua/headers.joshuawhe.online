...
<head>
    <meta charset="utf-8">
    <title>ExposureNotificationUI.ENUIUserConsentStatus.h</title>
...
/PrivateFrameworks/ExposureNotificationUI.framework/ExposureNotificationUI.ENUIUserConsentStatus.h <a href="?download" download title="Download" class="download">&darr;</a>
...
@interface ExposureNotificationUI.ENUIUserConsentStatus : NSObject {
    void dateConsented;
    void textConsented;
