...
<head>
    <meta charset="utf-8">
    <title>WBOfficeArtReaderClient.h</title>
...
/PrivateFrameworks/OfficeImport.framework/WBOfficeArtReaderClient.h <a href="?download" download title="Download" class="download">&darr;</a>
