...
<head>
    <meta charset="utf-8">
    <title>IMDCKAttachmentSyncController.h</title>
...
/PrivateFrameworks/IMDaemonCore.framework/IMDCKAttachmentSyncController.h <a href="?download" download title="Download" class="download">&darr;</a>
