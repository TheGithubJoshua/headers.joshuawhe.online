...
<head>
    <meta charset="utf-8">
    <title>FCModifyRecordsCommand.h</title>
...
/PrivateFrameworks/NewsCore.framework/FCModifyRecordsCommand.h <a href="?download" download title="Download" class="download">&darr;</a>
