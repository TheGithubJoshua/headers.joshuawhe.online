...
<head>
    <meta charset="utf-8">
    <title>AWDHomeKitEventTriggerEvent.h</title>
...
/PrivateFrameworks/HomeKitDaemon.framework/AWDHomeKitEventTriggerEvent.h <a href="?download" download title="Download" class="download">&darr;</a>
