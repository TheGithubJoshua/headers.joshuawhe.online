...
<head>
    <meta charset="utf-8">
    <title>HMDCameraIDSDeviceConnection.h</title>
...
/PrivateFrameworks/HomeKitDaemon.framework/HMDCameraIDSDeviceConnection.h <a href="?download" download title="Download" class="download">&darr;</a>
