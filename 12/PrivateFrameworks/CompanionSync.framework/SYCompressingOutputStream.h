...
<head>
    <meta charset="utf-8">
    <title>SYCompressingOutputStream.h</title>
...
/PrivateFrameworks/CompanionSync.framework/SYCompressingOutputStream.h <a href="?download" download title="Download" class="download">&darr;</a>
