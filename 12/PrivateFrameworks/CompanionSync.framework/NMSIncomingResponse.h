...
<head>
    <meta charset="utf-8">
    <title>NMSIncomingResponse.h</title>
...
/PrivateFrameworks/CompanionSync.framework/NMSIncomingResponse.h <a href="?download" download title="Download" class="download">&darr;</a>
