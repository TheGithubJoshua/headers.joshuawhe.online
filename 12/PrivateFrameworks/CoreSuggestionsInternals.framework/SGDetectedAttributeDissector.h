...
<head>
    <meta charset="utf-8">
    <title>SGDetectedAttributeDissector.h</title>
...
/PrivateFrameworks/CoreSuggestionsInternals.framework/SGDetectedAttributeDissector.h <a href="?download" download title="Download" class="download">&darr;</a>
