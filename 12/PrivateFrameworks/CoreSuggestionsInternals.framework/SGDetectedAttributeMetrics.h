...
<head>
    <meta charset="utf-8">
    <title>SGDetectedAttributeMetrics.h</title>
...
/PrivateFrameworks/CoreSuggestionsInternals.framework/SGDetectedAttributeMetrics.h <a href="?download" download title="Download" class="download">&darr;</a>
