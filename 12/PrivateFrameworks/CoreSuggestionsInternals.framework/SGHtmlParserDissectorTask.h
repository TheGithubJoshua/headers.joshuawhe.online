...
<head>
    <meta charset="utf-8">
    <title>SGHtmlParserDissectorTask.h</title>
...
/PrivateFrameworks/CoreSuggestionsInternals.framework/SGHtmlParserDissectorTask.h <a href="?download" download title="Download" class="download">&darr;</a>
