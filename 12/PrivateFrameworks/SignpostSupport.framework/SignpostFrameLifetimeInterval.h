...
<head>
    <meta charset="utf-8">
    <title>SignpostFrameLifetimeInterval.h</title>
...
/PrivateFrameworks/SignpostSupport.framework/SignpostFrameLifetimeInterval.h <a href="?download" download title="Download" class="download">&darr;</a>
