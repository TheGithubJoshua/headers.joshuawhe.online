...
<head>
    <meta charset="utf-8">
    <title>TSCETrackedReference.h</title>
...
/PrivateFrameworks/iWorkImport.framework/TSCETrackedReference.h <a href="?download" download title="Download" class="download">&darr;</a>
...
- (void)encodeToArchive:(struct TrackedReferenceArchive { int (**x1)(); struct InternalMetadataWithArena { void *x_2_1_1; } x2; struct HasBits<1> { unsigned int x_3_1_1[1]; } x3; struct CachedSize { struct atomic<int> { _Atomic int x_1_2_1; } x_4_1_1; } x4; struct ASTNodeArrayArchive {} *x5; unsigned int x6; }*)arg1 archiver:(id)arg2;
...
- (id)initFromArchive:(const struct TrackedReferenceArchive { int (**x1)(); struct InternalMetadataWithArena { void *x_2_1_1; } x2; struct HasBits<1> { unsigned int x_3_1_1[1]; } x3; struct CachedSize { struct atomic<int> { _Atomic int x_1_2_1; } x_4_1_1; } x4; struct ASTNodeArrayArchive {} *x5; unsigned int x6; }*)arg1;
- (id)initFromExpandedArchive:(const struct ExpandedTrackedReferenceArchive { int (**x1)(); struct InternalMetadataWithArena { void *x_2_1_1; } x2; struct HasBits<1> { unsigned int x_3_1_1[1]; } x3; struct CachedSize { struct atomic<int> { _Atomic int x_1_2_1; } x_4_1_1; } x4; struct ASTNodeArrayArchive {} *x5; unsigned int x6; unsigned int x7; }*)arg1;
