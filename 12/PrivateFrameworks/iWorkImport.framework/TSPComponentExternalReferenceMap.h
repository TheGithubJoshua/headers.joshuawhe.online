...
<head>
    <meta charset="utf-8">
    <title>TSPComponentExternalReferenceMap.h</title>
...
/PrivateFrameworks/iWorkImport.framework/TSPComponentExternalReferenceMap.h <a href="?download" download title="Download" class="download">&darr;</a>
...
- (void)appendReferencesFromMessage:(const struct RepeatedPtrField<TSP::ComponentExternalReference> { struct Arena {} *x1; int x2; int x3; struct Rep {} *x4; }*)arg1 componentIsVersioned:(bool)arg2;
