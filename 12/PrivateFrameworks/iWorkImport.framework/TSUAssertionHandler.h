...
<head>
    <meta charset="utf-8">
    <title>TSUAssertionHandler.h</title>
...
/PrivateFrameworks/iWorkImport.framework/TSUAssertionHandler.h <a href="?download" download title="Download" class="download">&darr;</a>
...
+ (void)handleFailureInFunction:(id)arg1 file:(id)arg2 lineNumber:(long long)arg3 isFatal:(bool)arg4 format:(id)arg5 args:(char *)arg6;
+ (void)initialize;
