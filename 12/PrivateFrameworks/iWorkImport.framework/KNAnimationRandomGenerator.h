...
<head>
    <meta charset="utf-8">
    <title>KNAnimationRandomGenerator.h</title>
...
/PrivateFrameworks/iWorkImport.framework/KNAnimationRandomGenerator.h <a href="?download" download title="Download" class="download">&darr;</a>
