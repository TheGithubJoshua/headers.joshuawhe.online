...
<head>
    <meta charset="utf-8">
    <title>TSPDocumentResourceDataAssetStorage.h</title>
...
/PrivateFrameworks/iWorkImport.framework/TSPDocumentResourceDataAssetStorage.h <a href="?download" download title="Download" class="download">&darr;</a>
