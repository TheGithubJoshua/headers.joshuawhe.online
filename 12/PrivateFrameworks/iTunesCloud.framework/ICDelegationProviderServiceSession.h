...
<head>
    <meta charset="utf-8">
    <title>ICDelegationProviderServiceSession.h</title>
...
/PrivateFrameworks/iTunesCloud.framework/ICDelegationProviderServiceSession.h <a href="?download" download title="Download" class="download">&darr;</a>
