...
/PrivateFrameworks/ExposureNotificationDaemon.framework/ENDaemon.h <a href="?download" download title="Download" class="download">&darr;</a>
...
@interface ENDaemon : NSObject <ApplicationObserver, ENConfigurationManagerDelegate, ENExposureDetectionManagerDelegate, ENOnboardingManagerDelegate, ENTemporaryExposureKeyManagerDelegate, SBSRemoteAlertHandleObserver, UNUserNotificationCenterDelegate> {
    ...
    struct NSMutableDictionary { Class x1; } * _appActivities;
    NSString * _appSchedulingBundleID;
    double  _appSchedulingInterval;
    NSBackgroundActivityScheduler * _appSchedulingScheduler;
    ...
    struct NSMutableDictionary { Class x1; } * _remoteUISessions;
...
- (void).cxx_destruct;
- (void)_activate;
- (void)_appSchedulingEnsureStarted;
- (void)_appSchedulingEnsureStopped;
...
- (struct NSMutableDictionary { Class x1; }*)appActivities;
...
- (struct NSMutableDictionary { Class x1; }*)remoteUISessions;
- (void)setActiveEntity:(id)arg1;
- (void)setAppActivities:(struct NSMutableDictionary { Class x1; }*)arg1;
...
- (void)setRemoteUISessions:(struct NSMutableDictionary { Class x1; }*)arg1;
