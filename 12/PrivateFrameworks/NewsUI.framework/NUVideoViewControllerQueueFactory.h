...
<head>
    <meta charset="utf-8">
    <title>NUVideoViewControllerQueueFactory.h</title>
...
/PrivateFrameworks/NewsUI.framework/NUVideoViewControllerQueueFactory.h <a href="?download" download title="Download" class="download">&darr;</a>
