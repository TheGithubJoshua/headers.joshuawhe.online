...
<head>
    <meta charset="utf-8">
    <title>NUVideoPlayerEventTracker.h</title>
...
/PrivateFrameworks/NewsUI.framework/NUVideoPlayerEventTracker.h <a href="?download" download title="Download" class="download">&darr;</a>
