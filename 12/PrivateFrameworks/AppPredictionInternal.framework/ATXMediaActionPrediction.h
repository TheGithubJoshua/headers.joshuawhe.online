...
<head>
    <meta charset="utf-8">
    <title>ATXMediaActionPrediction.h</title>
...
/PrivateFrameworks/AppPredictionInternal.framework/ATXMediaActionPrediction.h <a href="?download" download title="Download" class="download">&darr;</a>
...
+ (id)updatePlayMediaActionPredictions:(id)arg1 withUpcomingMedia:(id)arg2 forActionKey:(id)arg3 appActionPredictionItem:(const struct ATXPredictionItem { id x1; unsigned long long x2; float x3[348]; float x4; }*)arg4 appActionLogProbability:(double)arg5 statistics:(id)arg6;
