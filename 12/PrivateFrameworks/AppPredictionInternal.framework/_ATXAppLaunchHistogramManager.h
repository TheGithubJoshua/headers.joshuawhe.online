...
<head>
    <meta charset="utf-8">
    <title>_ATXAppLaunchHistogramManager.h</title>
...
/PrivateFrameworks/AppPredictionInternal.framework/_ATXAppLaunchHistogramManager.h <a href="?download" download title="Download" class="download">&darr;</a>
