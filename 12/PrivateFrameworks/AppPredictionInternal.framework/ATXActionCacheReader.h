...
<head>
    <meta charset="utf-8">
    <title>ATXActionCacheReader.h</title>
...
/PrivateFrameworks/AppPredictionInternal.framework/ATXActionCacheReader.h <a href="?download" download title="Download" class="download">&darr;</a>
...
- (struct ATXPredictionItem { id x1; unsigned long long x2; float x3[348]; float x4; })predictionItemForAction:(id)arg1;
