...
<head>
    <meta charset="utf-8">
    <title>PLSharedStreamsDataStore.h</title>
...
/PrivateFrameworks/PhotoLibraryServices.framework/PLSharedStreamsDataStore.h <a href="?download" download title="Download" class="download">&darr;</a>
