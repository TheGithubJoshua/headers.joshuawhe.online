...
<head>
    <meta charset="utf-8">
    <title>PLQuickActionManager.h</title>
...
/PrivateFrameworks/PhotoLibraryServices.framework/PLQuickActionManager.h <a href="?download" download title="Download" class="download">&darr;</a>
