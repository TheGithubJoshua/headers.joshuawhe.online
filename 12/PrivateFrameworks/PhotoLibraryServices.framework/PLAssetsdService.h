...
<head>
    <meta charset="utf-8">
    <title>PLAssetsdService.h</title>
...
/PrivateFrameworks/PhotoLibraryServices.framework/PLAssetsdService.h <a href="?download" download title="Download" class="download">&darr;</a>
