...
<head>
    <meta charset="utf-8">
    <title>PLPrimaryResourceDataStore.h</title>
...
/PrivateFrameworks/PhotoLibraryServices.framework/PLPrimaryResourceDataStore.h <a href="?download" download title="Download" class="download">&darr;</a>
