...
<head>
    <meta charset="utf-8">
    <title>PLManagedAssetRecoveryManager.h</title>
...
/PrivateFrameworks/PhotoLibraryServices.framework/PLManagedAssetRecoveryManager.h <a href="?download" download title="Download" class="download">&darr;</a>
