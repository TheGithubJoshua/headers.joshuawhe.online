...
<head>
    <meta charset="utf-8">
    <title>SUScriptSubscriptionStatusResponse.h</title>
...
/PrivateFrameworks/iTunesStoreUI.framework/SUScriptSubscriptionStatusResponse.h <a href="?download" download title="Download" class="download">&darr;</a>
