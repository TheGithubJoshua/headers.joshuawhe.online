...
<head>
    <meta charset="utf-8">
    <title>PXCMMPosterHeaderViewSpec.h</title>
...
/PrivateFrameworks/PhotosUICore.framework/PXCMMPosterHeaderViewSpec.h <a href="?download" download title="Download" class="download">&darr;</a>
