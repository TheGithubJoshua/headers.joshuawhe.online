...
<head>
    <meta charset="utf-8">
    <title>PXRelatedTileTransitionAnimationCoordinator.h</title>
...
/PrivateFrameworks/PhotosUICore.framework/PXRelatedTileTransitionAnimationCoordinator.h <a href="?download" download title="Download" class="download">&darr;</a>
...
- (void).cxx_destruct;
- (long long)_tileKindForIdentifier:(struct PXTileIdentifier { unsigned long long x1; unsigned long long x2[10]; })arg1;
- (id)change;
