...
/PrivateFrameworks/TSReading.framework/EQKitBox.h <a href="?download" download title="Download" class="download">&darr;</a>
...
@property (nonatomic) struct CGColor { }*fontSmoothingBackgroundColor;
...
- (struct CGColor { }*)fontSmoothingBackgroundColor;
