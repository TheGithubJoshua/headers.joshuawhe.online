...
<head>
    <meta charset="utf-8">
    <title>TSKAnnotationAuthorStorage.h</title>
...
/PrivateFrameworks/TSReading.framework/TSKAnnotationAuthorStorage.h <a href="?download" download title="Download" class="download">&darr;</a>
...
@property (nonatomic, retain) NSMutableSet *mutableAuthors;
...
- (void)setMutableAuthors:(id)arg1;
