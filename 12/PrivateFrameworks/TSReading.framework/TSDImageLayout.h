...
/PrivateFrameworks/TSReading.framework/TSDImageLayout.h <a href="?download" download title="Download" class="download">&darr;</a>
...
@property (nonatomic, readonly) bool hasMaskingPath;
@property (nonatomic, readonly) struct CGAffineTransform { double x1; double x2; double x3; double x4; double x5; double x6; } imageDataToVisualSizeTransform;
...
@property (nonatomic, readonly) struct CGAffineTransform { double x1; double x2; double x3; double x4; double x5; double x6; } layoutToImageTransform;
@property (nonatomic, readonly) struct CGAffineTransform { double x1; double x2; double x3; double x4; double x5; double x6; } layoutToMaskTransform;
@property (nonatomic, readonly) TSDMaskLayout *maskLayout;
@property (nonatomic, readonly) TSDLayoutGeometry *originalImageGeometry;
@property (nonatomic, readonly) const struct CGPath { }*pathToStroke;
...
- (const struct CGPath { }*)pathToStroke;
