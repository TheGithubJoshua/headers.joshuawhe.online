...
<head>
    <meta charset="utf-8">
    <title>TSPObjectContext.h</title>
...
/PrivateFrameworks/TSReading.framework/TSPObjectContext.h <a href="?download" download title="Download" class="download">&darr;</a>
...
@interface TSPObjectContext : NSObject <TSPFileCoordinatorDelegate, TSPLazyReferenceDelegate, TSPObjectDelegate, TSPPassphraseConsumer, TSPSupportDirectoryDelegate> {
...
@property (nonatomic, readonly) TSPObjectContainer *documentObjectContainer;
...
@property (nonatomic, readonly) TSPResourceContext *resourceContext;
...
@property (nonatomic, readonly) TSPObjectContainer *supportObjectContainer;
...
- (bool)closed;
- (id)componentManager;
- (void)conditionallyPerformResourceAccessUsingQueue:(id)arg1 block:(id /* block */)arg2;
...
- (void)prepareToReadSupportObjectExternalDataReferencesAllowed:(bool)arg1 accessor:(id /* block */)arg2;
