...
/PrivateFrameworks/TSReading.framework/TSTCell.h <a href="?download" download title="Download" class="download">&darr;</a>
...
@property (nonatomic, readonly) TSKFormat *booleanFormat;
...
@property (nonatomic, readonly) unsigned int cellFormatKind;
...
@property (nonatomic) struct TSCEDecimal { struct { unsigned long long x_1_1_1[2]; } x1; } currencyDecimalValue;
...
@property (nonatomic, readonly) bool currentFormatIsExplicitForCalcEngine;
...
@property (nonatomic, readonly) bool hasAnyCustomFormat;
@property (nonatomic, readonly) bool hasAnyFormats;
@property (nonatomic, readonly) bool hasAnyWarning;
@property (nonatomic, readonly) bool hasBooleanFormat;
...
@property (nonatomic, readonly) bool hasCurrencyFormat;
@property (nonatomic, readonly) bool hasCurrentFormat;
@property (nonatomic, readonly) bool hasDateFormat;
@property (nonatomic, readonly) bool hasDurationFormat;
...
@property (nonatomic, readonly) bool hasNumberFormat;
@property (nonatomic, readonly) bool hasRichText;
@property (nonatomic, readonly) bool hasStockFormulaForStockUI;
@property (nonatomic, readonly) bool hasTextFormat;
...
@property (nonatomic) struct TSCEDecimal { struct { unsigned long long x_1_1_1[2]; } x1; } numberDecimalValue;
...
@property (nonatomic, readonly) TSKFormat *textFormat;
...
- (void)applyFormulaResult:(const struct TSCEValue { unsigned long long x1[18]; int x2; }*)arg1;
- (void)applyFormulaResult:(const struct TSCEValue { unsigned long long x1[18]; int x2; }*)arg1 context:(id)arg2 hasWarnings:(bool)arg3 outWriteDidBeginOrEndWithTextCell:(bool*)arg4 propagateCheckboxesAndRatings:(bool)arg5;
- (void)applyPopupChoiceIndex:(unsigned long long)arg1;
- (void)bakeFormulaToValue;
- (bool)boolValue;
- (id)booleanFormat;
- (unsigned int)booleanFormatID;
...
- (unsigned int)controlCellSpecID;
...
- (struct TSCEDecimal { struct { unsigned long long x_1_1_1[2]; } x1; })currencyDecimalValue;
...
- (bool)hasAnyCustomFormat;
- (bool)hasAnyFormats;
- (bool)hasAnyWarning;
- (bool)hasBooleanFormat;
- (bool)hasCellSpec;
- (bool)hasCellStyle;
- (bool)hasCommentStorage;
- (bool)hasConditionalStyle;
- (bool)hasControl;
- (bool)hasCurrencyFormat;
- (bool)hasCurrentFormat;
- (bool)hasDateFormat;
- (bool)hasDurationFormat;
...
- (void)inflateFromStorageRef:(struct TSTCellStorage { struct { unsigned char x_1_1_1; unsigned int x_1_1_2 : 8; unsigned int x_1_1_3 : 16; unsigned int x_1_1_4 : 16; unsigned int x_1_1_5 : 16; unsigned int x_1_1_6 : 32; } x1; unsigned char x2[0]; }*)arg1 dataStore:(id)arg2;
- (void)inflateFromStorageRef:(struct TSTCellStorage { struct { unsigned char x_1_1_1; unsigned int x_1_1_2 : 8; unsigned int x_1_1_3 : 16; unsigned int x_1_1_4 : 16; unsigned int x_1_1_5 : 16; unsigned int x_1_1_6 : 32; } x1; unsigned char x2[0]; }*)arg1 dataStore:(id)arg2 suppressingTransmutation:(bool)arg3;
- (id)initWithLocale:(id)arg1;
- (id)initWithStorageRef:(struct TSTCellStorage { struct { unsigned char x_1_1_1; unsigned int x_1_1_2 : 8; unsigned int x_1_1_3 : 16; unsigned int x_1_1_4 : 16; unsigned int x_1_1_5 : 16; unsigned int x_1_1_6 : 32; } x1; unsigned char x2[0]; }*)arg1 dataStore:(id)arg2;
- (int)interactionType;
- (bool)isEmpty;
- (bool)isEmptyForDataStore;
- (bool)isMostRecentlyExplicitPercent;
- (id)locale;
- (struct TSCEDecimal { struct { unsigned long long x_1_1_1[2]; } x1; })numberDecimalValue;
...
- (void)setBooleanFormatID:(unsigned int)arg1;
...
- (void)setControlCellSpecID:(unsigned int)arg1;
- (void)setCurrencyDecimalValue:(struct TSCEDecimal { struct { unsigned long long x_1_1_1[2]; } x1; })arg1;
...
- (void)setNumberDecimalValue:(struct TSCEDecimal { struct { unsigned long long x_1_1_1[2]; } x1; })arg1;
...
- (void)setTextFormatID:(unsigned int)arg1;
