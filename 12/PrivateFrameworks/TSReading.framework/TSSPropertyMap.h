...
/PrivateFrameworks/TSReading.framework/TSSPropertyMap.h <a href="?download" download title="Download" class="download">&darr;</a>
...
- (void)pSetRepeatedArrayOfBools:(const struct RepeatedField<bool> { int x1; int x2; union Pointer { struct Arena {} *x_3_1_1; struct Rep {} *x_3_1_2; } x3; }*)arg1 forProperty:(int)arg2 defaultValues:(bool)arg3 validator:(id)arg4;
- (void)pSetRepeatedArrayOfFloats:(const struct RepeatedField<float> { int x1; int x2; union Pointer { struct Arena {} *x_3_1_1; struct Rep {} *x_3_1_2; } x3; }*)arg1 forProperty:(int)arg2 defaultValues:(float)arg3 validator:(id)arg4;
- (void)pSetRepeatedArrayOfInts:(const struct RepeatedField<int> { int x1; int x2; union Pointer { struct Arena {} *x_3_1_1; struct Rep {} *x_3_1_2; } x3; }*)arg1 forProperty:(int)arg2 defaultValues:(int)arg3 min:(int)arg4 max:(int)arg5 validator:(id)arg6;
- (void)pSetRepeatedArrayOfInts:(const struct RepeatedField<int> { int x1; int x2; union Pointer { struct Arena {} *x_3_1_1; struct Rep {} *x_3_1_2; } x3; }*)arg1 forProperty:(int)arg2 defaultValues:(int)arg3 min:(int)arg4 max:(int)arg5 validator:(id)arg6 usePreviousValueOnDefault:(bool)arg7;
