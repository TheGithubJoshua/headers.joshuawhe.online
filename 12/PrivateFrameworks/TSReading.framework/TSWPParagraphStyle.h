...
<head>
    <meta charset="utf-8">
    <title>TSWPParagraphStyle.h</title>
...
/PrivateFrameworks/TSReading.framework/TSWPParagraphStyle.h <a href="?download" download title="Download" class="download">&darr;</a>
...
@property (nonatomic, readonly) bool allowAsBookmarkSuggestionStyle;
@property (nonatomic, readonly) NSString *presetKind;
@property (nonatomic, readonly) bool showInSuggestedBookmarksList;
...
- (bool)showInSuggestedBookmarksList;
- (id)styleSummary;
