...
/PrivateFrameworks/TSReading.framework/TSWPFont.h <a href="?download" download title="Download" class="download">&darr;</a>
...
@property (nonatomic, readonly, copy) NSString *compatibilityName;
