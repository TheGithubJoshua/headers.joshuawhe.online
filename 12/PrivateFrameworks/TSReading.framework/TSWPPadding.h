...
/PrivateFrameworks/TSReading.framework/TSWPPadding.h <a href="?download" download title="Download" class="download">&darr;</a>
...
@interface TSWPPadding : NSObject <TSDMixing, TSSPropertyCommandSerializing, TSSPropertyValueArchiving> {
    double  _bottomInset;
    double  _leftInset;
    double  _rightInset;
    double  _topInset;
...
- (id)initWithArchive:(const struct PaddingArchive { int (**x1)(); struct InternalMetadataWithArena { void *x_2_1_1; } x2; struct HasBits<1> { unsigned int x_3_1_1[1]; } x3; struct CachedSize { struct atomic<int> { _Atomic int x_1_2_1; } x_4_1_1; } x4; float x5; float x6; float x7; float x8; }*)arg1 unarchiver:(id)arg2;
...
- (double)rightInset;
- (void)saveToArchive:(struct PaddingArchive { int (**x1)(); struct InternalMetadataWithArena { void *x_2_1_1; } x2; struct HasBits<1> { unsigned int x_3_1_1[1]; } x3; struct CachedSize { struct atomic<int> { _Atomic int x_1_2_1; } x_4_1_1; } x4; float x5; float x6; float x7; float x8; }*)arg1 archiver:(id)arg2;
