...
<head>
    <meta charset="utf-8">
    <title>TSWPFilteredStorage.h</title>
...
/PrivateFrameworks/TSReading.framework/TSWPFilteredStorage.h <a href="?download" download title="Download" class="download">&darr;</a>
...
+ (id)filteredStorageRemovingDeletionsFromStorage:(id)arg1 subRange:(struct _NSRange { unsigned long long x1; unsigned long long x2; })arg2;
...
- (void)enumerateSmartFieldsWithAttributeKind:(unsigned long long)arg1 inRange:(struct _NSRange { unsigned long long x1; unsigned long long x2; })arg2 usingBlock:(id /* block */)arg3;
- (void)enumerateWithAttributeKind:(unsigned long long)arg1 inRange:(struct _NSRange { unsigned long long x1; unsigned long long x2; })arg2 usingBlock:(id /* block */)arg3;
