...
/PrivateFrameworks/TSReading.framework/TSDGroupLayout.h <a href="?download" download title="Download" class="download">&darr;</a>
...
- (void)p_updateDescendentWrapPathsWithTransform:(struct CGAffineTransform { double x1; double x2; double x3; double x4; double x5; double x6; })arg1;
