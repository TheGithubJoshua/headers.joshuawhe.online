...
<head>
    <meta charset="utf-8">
    <title>TSDLayoutGeometry.h</title>
...
/PrivateFrameworks/TSReading.framework/TSDLayoutGeometry.h <a href="?download" download title="Download" class="download">&darr;</a>
...
@property (nonatomic, readonly) struct CGAffineTransform { double x1; double x2; double x3; double x4; double x5; double x6; } inverseTransform;
...
- (void)i_setSize:(struct CGSize { double x1; double x2; })arg1;
- (void)i_setTransform:(struct CGAffineTransform { double x1; double x2; double x3; double x4; double x5; double x6; })arg1;
- (id)infoGeometry;
- (id)init;
