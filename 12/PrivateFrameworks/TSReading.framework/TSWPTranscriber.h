...
/PrivateFrameworks/TSReading.framework/TSWPTranscriber.h <a href="?download" download title="Download" class="download">&darr;</a>
...
- (void)transcribeString:(id)arg1 withRange:(struct _NSRange { unsigned long long x1; unsigned long long x2; })arg2 locale:(id)arg3 inputLanguage:(id)arg4 block:(id /* block */)arg5;
