...
<head>
    <meta charset="utf-8">
    <title>TSWPTypesetterAttachmentMap.h</title>
...
/PrivateFrameworks/TSReading.framework/TSWPTypesetterAttachmentMap.h <a href="?download" download title="Download" class="download">&darr;</a>
...
- (void)dealloc;
- (bool)isWithinVerticalText;
- (id)layout;
- (bool)layoutNeedsRevalidation;
- (struct __CTLine { }*)lineRef;
- (void)setAttachment:(id)arg1;
- (void)setIsWithinVerticalText:(bool)arg1;
