...
/PrivateFrameworks/TSReading.framework/TSWPAttachment.h <a href="?download" download title="Download" class="download">&darr;</a>
...
@interface TSWPAttachment : TSPObject <TSDOwningAttachment, TSKDocumentObject, TSKModel, TSPCopying, TSWPStorageActionObjectProtocol> {
