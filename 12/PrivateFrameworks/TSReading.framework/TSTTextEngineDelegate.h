...
<head>
    <meta charset="utf-8">
    <title>TSTTextEngineDelegate.h</title>
...
/PrivateFrameworks/TSReading.framework/TSTTextEngineDelegate.h <a href="?download" download title="Download" class="download">&darr;</a>
...
- (id)initWithPadding:(struct UIEdgeInsets { double x1; double x2; double x3; double x4; })arg1 verticalAlignment:(int)arg2 locale:(id)arg3 shouldHyphenate:(bool)arg4;
- (id)locale;
