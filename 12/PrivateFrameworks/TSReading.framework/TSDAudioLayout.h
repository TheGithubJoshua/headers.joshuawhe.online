...
/PrivateFrameworks/TSReading.framework/TSDAudioLayout.h <a href="?download" download title="Download" class="download">&darr;</a>
...
+ (struct CGSize { double x1; double x2; })scaledAudioSize;
