...
/PrivateFrameworks/TSReading.framework/TSDFill.h <a href="?download" download title="Download" class="download">&darr;</a>
...
@interface TSDFill : NSObject <TSDPathPainter, TSSPreset, TSSPropertyCommandSerializing, TSSPropertyValueArchiving>
