...
<head>
    <meta charset="utf-8">
    <title>VKResourcesTileSource.h</title>
...
/PrivateFrameworks/VectorKit.framework/VKResourcesTileSource.h <a href="?download" download title="Download" class="download">&darr;</a>
