...
<head>
    <meta charset="utf-8">
    <title>VCSessionManager.h</title>
...
/PrivateFrameworks/AVConference.framework/VCSessionManager.h <a href="?download" download title="Download" class="download">&darr;</a>
