...
<head>
    <meta charset="utf-8">
    <title>VCPFrameAnalysisStats.h</title>
...
/PrivateFrameworks/VideoProcessing.framework/VCPFrameAnalysisStats.h <a href="?download" download title="Download" class="download">&darr;</a>
