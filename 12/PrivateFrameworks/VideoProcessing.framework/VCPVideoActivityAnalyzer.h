...
<head>
    <meta charset="utf-8">
    <title>VCPVideoActivityAnalyzer.h</title>
...
/PrivateFrameworks/VideoProcessing.framework/VCPVideoActivityAnalyzer.h <a href="?download" download title="Download" class="download">&darr;</a>
