...
<head>
    <meta charset="utf-8">
    <title>ASDPersonalizationStore.h</title>
...
/PrivateFrameworks/AppStoreDaemon.framework/ASDPersonalizationStore.h <a href="?download" download title="Download" class="download">&darr;</a>
