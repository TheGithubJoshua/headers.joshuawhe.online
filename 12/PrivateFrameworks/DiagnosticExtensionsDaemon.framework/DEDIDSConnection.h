...
<head>
    <meta charset="utf-8">
    <title>DEDIDSConnection.h</title>
...
/PrivateFrameworks/DiagnosticExtensionsDaemon.framework/DEDIDSConnection.h <a href="?download" download title="Download" class="download">&darr;</a>
