...
<head>
    <meta charset="utf-8">
    <title>SSPurchaseManager.h</title>
...
/PrivateFrameworks/StoreServices.framework/SSPurchaseManager.h <a href="?download" download title="Download" class="download">&darr;</a>
