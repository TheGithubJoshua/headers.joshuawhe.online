...
<head>
    <meta charset="utf-8">
    <title>SSMetricsBaseEvent.h</title>
...
/PrivateFrameworks/StoreServices.framework/SSMetricsBaseEvent.h <a href="?download" download title="Download" class="download">&darr;</a>
