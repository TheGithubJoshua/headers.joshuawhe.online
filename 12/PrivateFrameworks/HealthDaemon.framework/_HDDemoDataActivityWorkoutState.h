...
<head>
    <meta charset="utf-8">
    <title>_HDDemoDataActivityWorkoutState.h</title>
...
/PrivateFrameworks/HealthDaemon.framework/_HDDemoDataActivityWorkoutState.h <a href="?download" download title="Download" class="download">&darr;</a>
