...
<head>
    <meta charset="utf-8">
    <title>HDFitnessMachineDataCollector.h</title>
...
/PrivateFrameworks/HealthDaemon.framework/HDFitnessMachineDataCollector.h <a href="?download" download title="Download" class="download">&darr;</a>
