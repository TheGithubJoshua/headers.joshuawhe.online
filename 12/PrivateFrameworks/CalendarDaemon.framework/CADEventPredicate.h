...
<head>
    <meta charset="utf-8">
    <title>CADEventPredicate.h</title>
...
/PrivateFrameworks/CalendarDaemon.framework/CADEventPredicate.h <a href="?download" download title="Download" class="download">&darr;</a>
