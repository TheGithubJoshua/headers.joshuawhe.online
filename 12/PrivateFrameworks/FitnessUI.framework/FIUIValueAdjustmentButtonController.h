...
<head>
    <meta charset="utf-8">
    <title>FIUIValueAdjustmentButtonController.h</title>
...
/PrivateFrameworks/FitnessUI.framework/FIUIValueAdjustmentButtonController.h <a href="?download" download title="Download" class="download">&darr;</a>
