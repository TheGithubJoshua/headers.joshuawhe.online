...
<head>
    <meta charset="utf-8">
    <title>SVPrefetcherFactory.h</title>
...
/PrivateFrameworks/SilexVideo.framework/SVPrefetcherFactory.h <a href="?download" download title="Download" class="download">&darr;</a>
