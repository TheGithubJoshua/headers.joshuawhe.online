...
<head>
    <meta charset="utf-8">
    <title>SVVideoSkipThresholdObserver.h</title>
...
/PrivateFrameworks/SilexVideo.framework/SVVideoSkipThresholdObserver.h <a href="?download" download title="Download" class="download">&darr;</a>
