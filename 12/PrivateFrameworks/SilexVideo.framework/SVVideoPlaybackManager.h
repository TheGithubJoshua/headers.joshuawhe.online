...
<head>
    <meta charset="utf-8">
    <title>SVVideoPlaybackManager.h</title>
...
/PrivateFrameworks/SilexVideo.framework/SVVideoPlaybackManager.h <a href="?download" download title="Download" class="download">&darr;</a>
