...
<head>
    <meta charset="utf-8">
    <title>SVVideoProgressViewController.h</title>
...
/PrivateFrameworks/SilexVideo.framework/SVVideoProgressViewController.h <a href="?download" download title="Download" class="download">&darr;</a>
