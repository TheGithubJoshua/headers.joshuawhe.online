...
<head>
    <meta charset="utf-8">
    <title>SVVideoPlaybackEventTrackerManager.h</title>
...
/PrivateFrameworks/SilexVideo.framework/SVVideoPlaybackEventTrackerManager.h <a href="?download" download title="Download" class="download">&darr;</a>
