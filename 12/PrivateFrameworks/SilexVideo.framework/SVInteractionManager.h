...
<head>
    <meta charset="utf-8">
    <title>SVInteractionManager.h</title>
...
/PrivateFrameworks/SilexVideo.framework/SVInteractionManager.h <a href="?download" download title="Download" class="download">&darr;</a>
