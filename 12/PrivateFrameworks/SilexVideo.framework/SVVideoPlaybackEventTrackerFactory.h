...
<head>
    <meta charset="utf-8">
    <title>SVVideoPlaybackEventTrackerFactory.h</title>
...
/PrivateFrameworks/SilexVideo.framework/SVVideoPlaybackEventTrackerFactory.h <a href="?download" download title="Download" class="download">&darr;</a>
