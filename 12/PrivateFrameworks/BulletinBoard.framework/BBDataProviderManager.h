...
<head>
    <meta charset="utf-8">
    <title>BBDataProviderManager.h</title>
...
/PrivateFrameworks/BulletinBoard.framework/BBDataProviderManager.h <a href="?download" download title="Download" class="download">&darr;</a>
