...
<head>
    <meta charset="utf-8">
    <title>IMLockdownManager.h</title>
...
/PrivateFrameworks/IMFoundation.framework/IMLockdownManager.h <a href="?download" download title="Download" class="download">&darr;</a>
