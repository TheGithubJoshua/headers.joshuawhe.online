...
<head>
    <meta charset="utf-8">
    <title>CNObservedResult.h</title>
...
/PrivateFrameworks/ContactsFoundation.framework/CNObservedResult.h <a href="?download" download title="Download" class="download">&darr;</a>
