...
<head>
    <meta charset="utf-8">
    <title>PKPaymentSetupDockView.h</title>
...
/PrivateFrameworks/PassKitUI.framework/PKPaymentSetupDockView.h <a href="?download" download title="Download" class="download">&darr;</a>
