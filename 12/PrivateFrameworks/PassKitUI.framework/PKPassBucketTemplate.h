...
<head>
    <meta charset="utf-8">
    <title>PKPassBucketTemplate.h</title>
...
/PrivateFrameworks/PassKitUI.framework/PKPassBucketTemplate.h <a href="?download" download title="Download" class="download">&darr;</a>
