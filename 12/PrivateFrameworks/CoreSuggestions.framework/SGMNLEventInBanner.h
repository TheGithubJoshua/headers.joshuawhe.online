...
<head>
    <meta charset="utf-8">
    <title>SGMNLEventInBanner.h</title>
...
/PrivateFrameworks/CoreSuggestions.framework/SGMNLEventInBanner.h <a href="?download" download title="Download" class="download">&darr;</a>
