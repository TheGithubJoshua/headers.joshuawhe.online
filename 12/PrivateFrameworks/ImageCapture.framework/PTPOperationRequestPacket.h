...
<head>
    <meta charset="utf-8">
    <title>PTPOperationRequestPacket.h</title>
...
/PrivateFrameworks/ImageCapture.framework/PTPOperationRequestPacket.h <a href="?download" download title="Download" class="download">&darr;</a>
