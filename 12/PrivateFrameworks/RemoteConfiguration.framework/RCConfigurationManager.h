...
<head>
    <meta charset="utf-8">
    <title>RCConfigurationManager.h</title>
...
/PrivateFrameworks/RemoteConfiguration.framework/RCConfigurationManager.h <a href="?download" download title="Download" class="download">&darr;</a>
