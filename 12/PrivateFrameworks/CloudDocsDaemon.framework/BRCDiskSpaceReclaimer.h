...
<head>
    <meta charset="utf-8">
    <title>BRCDiskSpaceReclaimer.h</title>
...
/PrivateFrameworks/CloudDocsDaemon.framework/BRCDiskSpaceReclaimer.h <a href="?download" download title="Download" class="download">&darr;</a>
