...
<head>
    <meta charset="utf-8">
    <title>BRCServerChangeState.h</title>
...
/PrivateFrameworks/CloudDocsDaemon.framework/BRCServerChangeState.h <a href="?download" download title="Download" class="download">&darr;</a>
