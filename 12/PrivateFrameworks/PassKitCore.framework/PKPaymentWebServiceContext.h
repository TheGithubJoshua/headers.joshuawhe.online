...
<head>
    <meta charset="utf-8">
    <title>PKPaymentWebServiceContext.h</title>
...
/PrivateFrameworks/PassKitCore.framework/PKPaymentWebServiceContext.h <a href="?download" download title="Download" class="download">&darr;</a>
