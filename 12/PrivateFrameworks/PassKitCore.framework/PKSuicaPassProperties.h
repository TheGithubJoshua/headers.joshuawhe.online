...
<head>
    <meta charset="utf-8">
    <title>PKSuicaPassProperties.h</title>
...
/PrivateFrameworks/PassKitCore.framework/PKSuicaPassProperties.h <a href="?download" download title="Download" class="download">&darr;</a>
