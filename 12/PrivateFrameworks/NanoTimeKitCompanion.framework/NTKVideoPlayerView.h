...
<head>
    <meta charset="utf-8">
    <title>NTKVideoPlayerView.h</title>
...
/PrivateFrameworks/NanoTimeKitCompanion.framework/NTKVideoPlayerView.h <a href="?download" download title="Download" class="download">&darr;</a>
