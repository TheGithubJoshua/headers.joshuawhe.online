...
<head>
    <meta charset="utf-8">
    <title>BWInferenceDependencyProvider.h</title>
...
/PrivateFrameworks/Celestial.framework/BWInferenceDependencyProvider.h <a href="?download" download title="Download" class="download">&darr;</a>
