...
<head>
    <meta charset="utf-8">
    <title>BWQuickTimeMovieFileSinkNode.h</title>
...
/PrivateFrameworks/Celestial.framework/BWQuickTimeMovieFileSinkNode.h <a href="?download" download title="Download" class="download">&darr;</a>
