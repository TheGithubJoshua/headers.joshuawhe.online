...
<head>
    <meta charset="utf-8">
    <title>AWDIDSMagnetCorruptionDetailed.h</title>
...
/lib/libAWDSupportFramework.dylib/AWDIDSMagnetCorruptionDetailed.h <a href="?download" download title="Download" class="download">&darr;</a>
