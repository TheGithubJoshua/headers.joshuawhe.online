...
<head>
    <meta charset="utf-8">
    <title>AWDPowerDisplayBacklightMetrics.h</title>
...
/lib/libAWDSupportFramework.dylib/AWDPowerDisplayBacklightMetrics.h <a href="?download" download title="Download" class="download">&darr;</a>
