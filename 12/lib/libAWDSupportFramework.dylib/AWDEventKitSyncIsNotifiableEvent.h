...
<head>
    <meta charset="utf-8">
    <title>AWDEventKitSyncIsNotifiableEvent.h</title>
...
/lib/libAWDSupportFramework.dylib/AWDEventKitSyncIsNotifiableEvent.h <a href="?download" download title="Download" class="download">&darr;</a>
