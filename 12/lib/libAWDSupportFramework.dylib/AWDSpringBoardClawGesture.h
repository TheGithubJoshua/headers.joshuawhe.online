...
<head>
    <meta charset="utf-8">
    <title>AWDSpringBoardClawGesture.h</title>
...
/lib/libAWDSupportFramework.dylib/AWDSpringBoardClawGesture.h <a href="?download" download title="Download" class="download">&darr;</a>
