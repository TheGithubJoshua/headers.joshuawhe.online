...
<head>
    <meta charset="utf-8">
    <title>SFAnalyticsSQLiteStore.h</title>
...
/Frameworks/Security.framework/SFAnalyticsSQLiteStore.h <a href="?download" download title="Download" class="download">&darr;</a>
