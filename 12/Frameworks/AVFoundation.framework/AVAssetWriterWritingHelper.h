...
<head>
    <meta charset="utf-8">
    <title>AVAssetWriterWritingHelper.h</title>
...
/Frameworks/AVFoundation.framework/AVAssetWriterWritingHelper.h <a href="?download" download title="Download" class="download">&darr;</a>
