...
<head>
    <meta charset="utf-8">
    <title>QLRemotePreviewCollection.h</title>
...
/Frameworks/QuickLook.framework/QLRemotePreviewCollection.h <a href="?download" download title="Download" class="download">&darr;</a>
