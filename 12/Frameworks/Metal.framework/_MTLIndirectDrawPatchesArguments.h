...
<head>
    <meta charset="utf-8">
    <title>_MTLIndirectDrawPatchesArguments.h</title>
...
/Frameworks/Metal.framework/_MTLIndirectDrawPatchesArguments.h <a href="?download" download title="Download" class="download">&darr;</a>
