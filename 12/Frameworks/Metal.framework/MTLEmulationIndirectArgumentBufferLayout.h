...
<head>
    <meta charset="utf-8">
    <title>MTLEmulationIndirectArgumentBufferLayout.h</title>
...
/Frameworks/Metal.framework/MTLEmulationIndirectArgumentBufferLayout.h <a href="?download" download title="Download" class="download">&darr;</a>
