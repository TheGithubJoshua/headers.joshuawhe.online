...
<head>
    <meta charset="utf-8">
    <title>_HMCameraSnapshotControl.h</title>
...
/Frameworks/HomeKit.framework/_HMCameraSnapshotControl.h <a href="?download" download title="Download" class="download">&darr;</a>
