...
<head>
    <meta charset="utf-8">
    <title>PUCameraPreviewPresentationController.h</title>
...
/Frameworks/PhotosUI.framework/PUCameraPreviewPresentationController.h <a href="?download" download title="Download" class="download">&darr;</a>
