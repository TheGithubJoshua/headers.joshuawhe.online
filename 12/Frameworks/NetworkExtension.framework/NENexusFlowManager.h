...
<head>
    <meta charset="utf-8">
    <title>NENexusFlowManager.h</title>
...
/Frameworks/NetworkExtension.framework/NENexusFlowManager.h <a href="?download" download title="Download" class="download">&darr;</a>
