...
<head>
    <meta charset="utf-8">
    <title>AVHapticPlayerChannel.h</title>
...
/Frameworks/AudioToolbox.framework/AVHapticPlayerChannel.h <a href="?download" download title="Download" class="download">&darr;</a>
