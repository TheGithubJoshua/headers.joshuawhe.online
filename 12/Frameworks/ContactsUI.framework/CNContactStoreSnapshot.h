...
<head>
    <meta charset="utf-8">
    <title>CNContactStoreSnapshot.h</title>
...
/Frameworks/ContactsUI.framework/CNContactStoreSnapshot.h <a href="?download" download title="Download" class="download">&darr;</a>
