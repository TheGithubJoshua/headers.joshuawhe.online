...
<head>
    <meta charset="utf-8">
    <title>CKDPRecordFieldValueEncryptedValue.h</title>
...
/Frameworks/CloudKit.framework/CKDPRecordFieldValueEncryptedValue.h <a href="?download" download title="Download" class="download">&darr;</a>
