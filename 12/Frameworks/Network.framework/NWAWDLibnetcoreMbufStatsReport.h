...
<head>
    <meta charset="utf-8">
    <title>NWAWDLibnetcoreMbufStatsReport.h</title>
...
/Frameworks/Network.framework/NWAWDLibnetcoreMbufStatsReport.h <a href="?download" download title="Download" class="download">&darr;</a>
