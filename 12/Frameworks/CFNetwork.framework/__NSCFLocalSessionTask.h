...
<head>
    <meta charset="utf-8">
    <title>__NSCFLocalSessionTask.h</title>
...
/Frameworks/CFNetwork.framework/__NSCFLocalSessionTask.h <a href="?download" download title="Download" class="download">&darr;</a>
