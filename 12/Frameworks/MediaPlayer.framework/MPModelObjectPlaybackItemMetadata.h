...
<head>
    <meta charset="utf-8">
    <title>MPModelObjectPlaybackItemMetadata.h</title>
...
/Frameworks/MediaPlayer.framework/MPModelObjectPlaybackItemMetadata.h <a href="?download" download title="Download" class="download">&darr;</a>
