...
<head>
    <meta charset="utf-8">
    <title>MPModelStoreBrowseRequest.h</title>
...
/Frameworks/MediaPlayer.framework/MPModelStoreBrowseRequest.h <a href="?download" download title="Download" class="download">&darr;</a>
