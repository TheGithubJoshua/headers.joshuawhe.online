...
<head>
    <meta charset="utf-8">
    <title>MPStoreModelAlbumBuilder.h</title>
...
/Frameworks/MediaPlayer.framework/MPStoreModelAlbumBuilder.h <a href="?download" download title="Download" class="download">&darr;</a>
