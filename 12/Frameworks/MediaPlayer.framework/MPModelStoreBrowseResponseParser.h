...
<head>
    <meta charset="utf-8">
    <title>MPModelStoreBrowseResponseParser.h</title>
...
/Frameworks/MediaPlayer.framework/MPModelStoreBrowseResponseParser.h <a href="?download" download title="Download" class="download">&darr;</a>
