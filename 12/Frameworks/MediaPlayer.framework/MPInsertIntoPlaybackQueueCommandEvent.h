...
<head>
    <meta charset="utf-8">
    <title>MPInsertIntoPlaybackQueueCommandEvent.h</title>
...
/Frameworks/MediaPlayer.framework/MPInsertIntoPlaybackQueueCommandEvent.h <a href="?download" download title="Download" class="download">&darr;</a>
