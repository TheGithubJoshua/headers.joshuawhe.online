...
<head>
    <meta charset="utf-8">
    <title>MPSetPlaybackQueueCommand.h</title>
...
/Frameworks/MediaPlayer.framework/MPSetPlaybackQueueCommand.h <a href="?download" download title="Download" class="download">&darr;</a>
