...
<head>
    <meta charset="utf-8">
    <title>MPMediaLibraryPlaybackItemMetadata.h</title>
...
/Frameworks/MediaPlayer.framework/MPMediaLibraryPlaybackItemMetadata.h <a href="?download" download title="Download" class="download">&darr;</a>
