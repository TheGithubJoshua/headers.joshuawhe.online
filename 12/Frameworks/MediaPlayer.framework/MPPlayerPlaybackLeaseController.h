...
<head>
    <meta charset="utf-8">
    <title>MPPlayerPlaybackLeaseController.h</title>
...
/Frameworks/MediaPlayer.framework/MPPlayerPlaybackLeaseController.h <a href="?download" download title="Download" class="download">&darr;</a>
