...
<head>
    <meta charset="utf-8">
    <title>MPStorePlayWhileDownloadSession.h</title>
...
/Frameworks/MediaPlayer.framework/MPStorePlayWhileDownloadSession.h <a href="?download" download title="Download" class="download">&darr;</a>
