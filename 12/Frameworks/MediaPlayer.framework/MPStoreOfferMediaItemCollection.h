...
<head>
    <meta charset="utf-8">
    <title>MPStoreOfferMediaItemCollection.h</title>
...
/Frameworks/MediaPlayer.framework/MPStoreOfferMediaItemCollection.h <a href="?download" download title="Download" class="download">&darr;</a>
