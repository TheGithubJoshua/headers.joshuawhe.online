...
<head>
    <meta charset="utf-8">
    <title>MPRestrictionsMonitor.h</title>
...
/Frameworks/MediaPlayer.framework/MPRestrictionsMonitor.h <a href="?download" download title="Download" class="download">&darr;</a>
