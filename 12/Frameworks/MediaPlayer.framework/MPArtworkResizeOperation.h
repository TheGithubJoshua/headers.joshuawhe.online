...
<head>
    <meta charset="utf-8">
    <title>MPArtworkResizeOperation.h</title>
...
/Frameworks/MediaPlayer.framework/MPArtworkResizeOperation.h <a href="?download" download title="Download" class="download">&darr;</a>
