...
<head>
    <meta charset="utf-8">
    <title>MPStoreAssetInfoPlaybackCacheRequest.h</title>
...
/Frameworks/MediaPlayer.framework/MPStoreAssetInfoPlaybackCacheRequest.h <a href="?download" download title="Download" class="download">&darr;</a>
