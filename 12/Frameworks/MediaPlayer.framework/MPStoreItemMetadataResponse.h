...
<head>
    <meta charset="utf-8">
    <title>MPStoreItemMetadataResponse.h</title>
...
/Frameworks/MediaPlayer.framework/MPStoreItemMetadataResponse.h <a href="?download" download title="Download" class="download">&darr;</a>
