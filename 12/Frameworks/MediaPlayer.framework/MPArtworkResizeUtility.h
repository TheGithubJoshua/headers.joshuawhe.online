...
<head>
    <meta charset="utf-8">
    <title>MPArtworkResizeUtility.h</title>
...
/Frameworks/MediaPlayer.framework/MPArtworkResizeUtility.h <a href="?download" download title="Download" class="download">&darr;</a>
