...
<head>
    <meta charset="utf-8">
    <title>MPModelLibraryTransientStateController.h</title>
...
/Frameworks/MediaPlayer.framework/MPModelLibraryTransientStateController.h <a href="?download" download title="Download" class="download">&darr;</a>
