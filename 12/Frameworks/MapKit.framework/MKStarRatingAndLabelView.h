...
<head>
    <meta charset="utf-8">
    <title>MKStarRatingAndLabelView.h</title>
...
/Frameworks/MapKit.framework/MKStarRatingAndLabelView.h <a href="?download" download title="Download" class="download">&darr;</a>
