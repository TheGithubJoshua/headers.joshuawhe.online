...
<head>
    <meta charset="utf-8">
    <title>_NSSQLTableMigrationDescription.h</title>
...
/Frameworks/CoreData.framework/_NSSQLTableMigrationDescription.h <a href="?download" download title="Download" class="download">&darr;</a>
