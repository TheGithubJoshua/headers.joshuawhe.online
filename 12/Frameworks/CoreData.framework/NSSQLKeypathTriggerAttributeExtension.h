...
<head>
    <meta charset="utf-8">
    <title>NSSQLKeypathTriggerAttributeExtension.h</title>
...
/Frameworks/CoreData.framework/NSSQLKeypathTriggerAttributeExtension.h <a href="?download" download title="Download" class="download">&darr;</a>
