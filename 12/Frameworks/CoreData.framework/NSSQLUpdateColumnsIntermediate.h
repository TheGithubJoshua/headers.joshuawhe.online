...
<head>
    <meta charset="utf-8">
    <title>NSSQLUpdateColumnsIntermediate.h</title>
...
/Frameworks/CoreData.framework/NSSQLUpdateColumnsIntermediate.h <a href="?download" download title="Download" class="download">&darr;</a>
