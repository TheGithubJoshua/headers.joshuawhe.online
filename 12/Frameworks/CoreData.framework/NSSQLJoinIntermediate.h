...
<head>
    <meta charset="utf-8">
    <title>NSSQLJoinIntermediate.h</title>
...
/Frameworks/CoreData.framework/NSSQLJoinIntermediate.h <a href="?download" download title="Download" class="download">&darr;</a>
