...
<head>
    <meta charset="utf-8">
    <title>NSSQLSubqueryExpressionIntermediate.h</title>
...
/Frameworks/CoreData.framework/NSSQLSubqueryExpressionIntermediate.h <a href="?download" download title="Download" class="download">&darr;</a>
