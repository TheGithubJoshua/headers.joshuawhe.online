...
<head>
    <meta charset="utf-8">
    <title>_NSItemProviderCopyingLoadOperator.h</title>
...
/Frameworks/Foundation.framework/_NSItemProviderCopyingLoadOperator.h <a href="?download" download title="Download" class="download">&darr;</a>
