...
<head>
    <meta charset="utf-8">
    <title>_INPBSearchForAccountsIntent.h</title>
...
/Frameworks/Intents.framework/_INPBSearchForAccountsIntent.h <a href="?download" download title="Download" class="download">&darr;</a>
