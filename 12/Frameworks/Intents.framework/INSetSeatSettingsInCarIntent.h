...
<head>
    <meta charset="utf-8">
    <title>INSetSeatSettingsInCarIntent.h</title>
...
/Frameworks/Intents.framework/INSetSeatSettingsInCarIntent.h <a href="?download" download title="Download" class="download">&darr;</a>
