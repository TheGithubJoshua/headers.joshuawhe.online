...
<head>
    <meta charset="utf-8">
    <title>INRestaurantGuestDisplayPreferences.h</title>
...
/Frameworks/Intents.framework/INRestaurantGuestDisplayPreferences.h <a href="?download" download title="Download" class="download">&darr;</a>
