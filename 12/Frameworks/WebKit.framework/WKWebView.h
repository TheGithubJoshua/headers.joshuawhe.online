...
/Frameworks/WebKit.framework/WKWebView.h <a href="?download" download title="Download" class="download">&darr;</a>
...
- (void)_didInsertAttachment:(struct Attachment { int (**x1)(); id x2; struct RetainPtr<NSFileWrapper> { void *x_3_1_1; } x3; struct Function<WTF::RetainPtr<NSFileWrapper> ()>={unique_ptr<WTF::Function<WTF::RetainPtr<NSFileWrapper> ()>::CallableWrapperBase, std::__1::default_delete<WTF::Function<WTF::RetainPtr<NSFileWrapper> ()>::CallableWrapperBase> >={__compressed_pair<WTF::Function<WTF::RetainPtr<NSFileWrapper> ()>::CallableWrapperBase *, std::__1::default_delete<WTF::Function<WTF::RetainPtr<NSFileWrapper> ()>::CallableWrapperBase> >=^{CallableWrapperBase {} x4; }*)arg1 withSource:(id)arg2;
- (void)_didInvalidateDataForAttachment:(struct Attachment { int (**x1)(); id x2; struct RetainPtr<NSFileWrapper> { void *x_3_1_1; } x3; struct Function<WTF::RetainPtr<NSFileWrapper> ()>={unique_ptr<WTF::Function<WTF::RetainPtr<NSFileWrapper> ()>::CallableWrapperBase, std::__1::default_delete<WTF::Function<WTF::RetainPtr<NSFileWrapper> ()>::CallableWrapperBase> >={__compressed_pair<WTF::Function<WTF::RetainPtr<NSFileWrapper> ()>::CallableWrapperBase *, std::__1::default_delete<WTF::Function<WTF::RetainPtr<NSFileWrapper> ()>::CallableWrapperBase> >=^{CallableWrapperBase {} x4; }*)arg1;
