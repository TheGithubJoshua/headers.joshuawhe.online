...
<head>
    <meta charset="utf-8">
    <title>TSCEReferenceResolving.h</title>
...
/protocols/TSCEReferenceResolving.h <a href="?download" download title="Download" class="download">&darr;</a>
...
- (NSMutableIndexSet *)mutableIndexesForUIDs:(const struct vector<TSU::UUIDData<TSP::UUIDData>, std::__1::allocator<TSU::UUIDData<TSP::UUIDData> > > { struct UUIDData<TSP::UUIDData> {} *x1; struct UUIDData<TSP::UUIDData> {} *x2; struct __compressed_pair<TSU::UUIDData<TSP::UUIDData> *, std::__1::allocator<TSU::UUIDData<TSP::UUIDData> > > { struct UUIDData<TSP::UUIDData> {} *x_3_1_1; } x3; }*)arg1 isRows:(bool)arg2;
