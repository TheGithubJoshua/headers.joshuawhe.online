...
<head>
    <meta charset="utf-8">
    <title>TSDCanvasDelegate.h</title>
...
/protocols/TSDCanvasDelegate.h <a href="?download" download title="Download" class="download">&darr;</a>
...
- (<TSDCanvasProxyDelegate> *)canvasProxyDelegate;
