...
/protocols/TSWPLayoutOwner.h <a href="?download" download title="Download" class="download">&darr;</a>
...
- (<TSWPOffscreenColumn> *)nextTargetFirstColumnForTarget:(id <TSWPLayoutTarget>)arg1;
- (NSObject<TSWPTopicNumberHints> *)nextTargetTopicNumbersForTarget:(id <TSWPLayoutTarget>)arg1;
- (<TSWPOffscreenColumn> *)previousTargetLastColumnForTarget:(id <TSWPLayoutTarget>)arg1;
