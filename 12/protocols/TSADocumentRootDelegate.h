...
<head>
    <meta charset="utf-8">
    <title>TSADocumentRootDelegate.h</title>
...
/protocols/TSADocumentRootDelegate.h <a href="?download" download title="Download" class="download">&darr;</a>
...
- (TSACollaborationErrorAction *)collaborationDisallowedErrorAction;
...
- (bool)shouldSkipStartRecalculationOnLoad;
- (void)willPostUndoManagerNotificationsUsingBlock:(void *)arg1; // needs 1 arg types, found 5: id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, void*
